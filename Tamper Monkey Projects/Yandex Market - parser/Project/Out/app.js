...
window.initializeMethods([clearAllData, clearInfo, clearLinks, Parser, getErrors, dataGetters_getLinks, getItemsData, downloadData, setItemsLinks, ToNextLink]); //Вывод информации в консоль
